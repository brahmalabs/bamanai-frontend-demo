  ...
  return (
    <GoogleOAuthProvider clientId={process.env.REACT_APP_GOOGLE_CLIENT_ID || '85855602562-ah91c2s403kvjm44gheh5aqh260beik2.apps.googleusercontent.com'}>
      <div className="flex flex-col items-center justify-center min-h-screen w-full text-black bg-gray-100">
        ...
        <p className="text-xl mb-8 px-16">BamanAI allows you to create your own AI assistant who will be available 24/7 to your students. You can use BamanAI to help you with your students' questions, assignments, and more.</p>
        ...
        <footer className="absolute bottom-0 w-full text-center py-4 bg-gray-100">
          <p className="text-sm text-gray-600">
            An Experiment by <img src="https://brahma-labs.com/img/logo-royal-blue.png" alt="Brahma Labs" className="inline h-4 mx-1" /> Brahma Labs
          </p>
        </footer>
      </div>
    </GoogleOAuthProvider>
