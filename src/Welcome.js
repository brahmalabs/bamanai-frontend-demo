      ...
      <div className="flex flex-col items-center justify-center min-h-screen w-full text-black bg-gray-100">
        ...
        <footer className="absolute bottom-0 w-full text-center py-4 bg-gray-100">
          <p className="text-sm text-gray-600">
            An <a href="https://github.com/vidhatatrivedy/bamanai" target="_blank" className="text-teal-600">Open Source</a> Experiment by <img src="https://brahma-labs.com/img/logo-royal-blue.png" alt="Brahma Labs" className="inline h-4 mx-1" /> Brahma Labs
          </p>
        </footer>
      </div>
    </GoogleOAuthProvider>
